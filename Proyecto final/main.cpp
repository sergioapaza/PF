...
int main() {
    // Crear un banco y un cajero
    Cajero cajero;

    // Crear cuentas para clientes
    Cuenta cuenta1(12345, "Juan Pérez", 11111111, true, true, "contraseña1", true);
    Cuenta cuenta2(67890, "María Gómez", 22222222, false, false, "contraseña2", false);
    ...
    // Crear clientes
    Cliente cliente1(11111111, "Juan Pérez", &cuenta1, &cajero);
    Cliente cliente2(22222222, "María Gómez", &cuenta2, &cajero);
